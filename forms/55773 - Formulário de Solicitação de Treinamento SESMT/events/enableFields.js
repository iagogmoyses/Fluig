function enableFields(form){ 
	...
	var colaborador = buscaUsuario(usuario);
	...
	//fase9
	form.setEnabled("just_fase9"            , false);
	...
	if(ativ == 15){ //SOLICITA DOCS PARA SOLICITANTE
	...
	if(ativ == 67){ //ANEXAR DOC ASSINADO
		for (var i = 0; i < indexes2.length; i++) {
	...
	if(ativ == 78 || ativ == 104 ){ //Libera Portaria de Inicio de Trabalho
	...
	if(ativ == 82){ //SESMT AGUARDANDO DOCS
		form.setEnabled("just_fase9"            , true);
		form.setValue('aprovador_fase9', colaborador.getValue(0, "colleagueName"));
		form.setValue('haprovador_fase9_login', colaborador.getValue(0, "login"));
		form.setValue('haprovador_fase9_mail', colaborador.getValue(0, "mail"));
	}
